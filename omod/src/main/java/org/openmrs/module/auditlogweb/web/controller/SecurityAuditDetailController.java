...
/**
 * Controller for displaying security audit event details. Maps to
 * /module/auditlogweb/viewSecurityAudit.form?eventId={id} Displays the event details and related
